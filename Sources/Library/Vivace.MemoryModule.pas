...
uses
  Windows;
function  ViMemoryLoadLibrary(Data: Pointer): Pointer; stdcall;
function  ViMemoryGetProcAddress(Module: Pointer; const Name: PAnsiChar): Pointer; stdcall;
procedure ViMemoryFreeLibrary(Module: Pointer); stdcall;
implementation
